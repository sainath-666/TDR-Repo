...
export const en: TranslationTree = {
  ...
  statusPage: {
    ...
    raiseRequest: 'Raise a Request to Check TDR',
    requestTitle: 'Request TDR Status Check',
    requestSubtitle:
      'Submit the TDR certificate number, supporting documents, and remarks for verification.',
    documents: 'Documents',
    documentsHint: 'Upload PDF, JPG, or PNG files (max 5 MB each, up to 10 files).',
    uploadDocuments: 'Choose documents to upload',
    removeDocument: 'Remove document',
    errorNoDocuments: 'Please upload at least one document.',
    errorInvalidDocument: '{fileName} is not a supported file type. Use PDF, JPG, or PNG.',
    errorDocumentTooLarge: '{fileName} is too large. Each file must be 5 MB or smaller.',
    remarks: 'Remarks',
    remarksPlaceholder: 'Any additional details about your TDR certificate',
    ...
    requestSuccessMessage:
      'Your request has been received. Please save the reference number below for follow-up.',
    existingRequestTitle: 'Status Check Request Already Submitted',
    existingRequestMessage:
      'A status check request for TDR number "{tdrNumber}" is already under review.',
